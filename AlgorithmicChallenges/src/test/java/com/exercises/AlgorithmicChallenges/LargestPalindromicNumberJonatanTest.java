...
class LargestPalindromicNumberJonatanTest {

	private LargestPalindromicNumberJonatan largestPalindromicNumber;

    @BeforeEach
    public void initialSetUp() {
        this.largestPalindromicNumber = new LargestPalindromicNumberJonatan();
    }
